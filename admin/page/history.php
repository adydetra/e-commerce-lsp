...
<body>
	...
	<?php 
        ...
        JOIN printer_tb ON printer_tb.IdPrinter = transaksi.Printer_tbIdPrinter");
	...
	<main class="content-wrap">
		<header class="content-head">
			<h1>History / Riwayat Transaksi</h1>
		...
		<div class="content">
			<section class="info-boxes">
				<div class="info-box">
					...
					<span class="big">
							<?php
								$jumlah_transaksi = mysqli_query($koneksi, "SELECT count(*) as status FROM transaksi WHERE status='2' ");
								while($jumlah_tran = mysqli_fetch_array($jumlah_transaksi)){
									echo $jumlah_tran['status'];
								}
							?>
						</span>
						Total Sudah Dikonfirmasi
					</div>
				</div>
			...
			<section class="container-table">
                ...
                <table width='80%' border=1>
                    ...
                    while($hasil = mysqli_fetch_object($transaksi)) { if ($hasil->status == 2) { ?>
                        ...
                        <td class="text-center green">Sudah Konfirmasi</td>
                        <td class="text-center"><a class="red" href="../../proses/hapus_history.php?IdTransaksi=<?= $hasil->IdTransaksi ?>">Hapus</a></td>
                        </tr>   
