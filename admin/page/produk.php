	...
	<main class="content-wrap">
		...
		<div class="content">
			...
			<section class="container-table">
				...
				<tr>
					<th>Gambar</th> <th>Nama</th> <th>Spesifikasi</th> <th>Harga</th> <th>Stok</th> <th>Opsi</th>
				</tr>
				<?php //Perulangan untuk tabel printer_tb
				while($printer = mysqli_fetch_array($result)) { ?>      
					<tr>
					<td class="text-center"><img src="../../img/post/<?= $printer['image']; ?>" alt="gambar"></td>
					<td><?= $printer['NamaPrinter']; ?></td>
					<td><?= $printer['SpesifikasiPrinter']; ?></td>
					<td><?= "Rp. " . number_format($printer['HargaPrinter'], 0, ".", "."); ?></td>
					<td class="text-center"><?= $printer['stok']; ?></td>
					<td class="text-center"><a id="edit" href="../edit.php?IdPrinter=<?=$printer['IdPrinter']; ?>">Edit</a> | <a class="red" id="delete" href="../delete.php?IdPrinter=<?=$printer['IdPrinter']; ?>">Delete</a></td></tr>        
				<?php
				}
				?>
				</table> <br>
